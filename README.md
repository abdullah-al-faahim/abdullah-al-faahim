...
## Skills:
[![My Skills](https://skillicons.dev/icons?i=ai,ps,pr,id,au,ae,figma,autocad,blender,xd,html,css,js,latex,notion,wordpress,git,github,gitlab,discord,windows,apple,linux,mint,kali,debian,arch,aws,azure,visualstudio,vercel,vscode,pycharm,linkedin,gmail,powershell&perline=6)](https://skillicons.dev)
